...
export default function VagasActionButtons({ id, nome, descricao, salario, onEditComplete }: JobOffer) {
  return (
    <div className="flex justify-row mx-3">
      <ActionDelete id={id} nome={nome} onEditComplete={onEditComplete}/>
      <ActionEdit id={id} nome={nome} descricao={descricao} salario={salario} onEditComplete={onEditComplete}/>
